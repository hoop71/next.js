...
Attributes on spans follow [OpenTelemetry semantic conventions](https://opentelemetry.io/docs/concepts/semantic-conventions/). We also add some custom attributes under the `next` namespace:
...
- [Common HTTP attributes](https://opentelemetry.io/docs/specs/semconv/http/http-metrics/)
  - `http.method`
  - `http.status_code`
- [Server HTTP attributes](https://opentelemetry.io/docs/specs/semconv/http/)
  - `http.route`
  - `http.target`
- `next.span_name`
- `next.span_type`
